...
class DataService {
    ...
    private var _REF_USERES = DB_BASE.child("users")
    ...
    func getUserName(forUID uid: String, Complition: @escaping (_ username: String) -> ()){
    ...
    func ceateGroup(withTitle title: String, andDescription description: String, forUserIds ids: [String],
        ...
        REF_GROUPS.observeSingleEvent(of: .value) { (groupSnapshot) in
            ...
            for group in groupSnapshot {
                ...
                if memberArray.contains((Auth.auth().currentUser?.uid)!){
                    ...
                    let group = Group(title: title, description: desc, key: group.key, memebers: memberArray, memberCount: memberArray.count)
